...
<body>
    ...
    <form action="signupProcess.jsp" method="post">
      <div class="container">
          ...
          <div class="label-container">
              <label for="password-repeat"><b>再次輸入密碼:</b></label>
          ...
          <div class="clearfix">
              <button type="submit" class="signupbtn">加入會員</button>
          </div>
